      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-4xl font-bold mb-4 font-playfair text-navy-text">
              The Ligno-Pod: In-Situ Nutrient Recovery
            </h2>
            <p className="text-base leading-relaxed mb-6 text-navy-text/70 font-inter">
            ...
            <div className="flex flex-col gap-5">
              {SOLUTION_FEATURES.map((f, i) => (
                <div key={i} className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold mb-1 font-inter text-navy-text">{f.title}</h4>
                    <p className="text-sm leading-relaxed text-navy-text/70 font-inter">{f.desc}</p>
                  </div>
                </div>
              ))}
            </div>
